...
fn default_strong_multiplier() -> f32 { 1.5 }
fn default_weak_multiplier() -> f32 { 0.7 }
fn default_force_clamp_min() -> f32 { 0.5 }
fn default_force_clamp_max() -> f32 { 2.0 }
fn default_strong_percentile() -> f32 { 0.2 } // Top 20%
fn default_weak_percentile() -> f32 { 0.2 }   // Bottom 20%
...
fn default_discount_factor() -> f32 { 0.95 }
fn default_epsilon_start() -> f32 { 0.3 }
fn default_epsilon_decay() -> f32 { 0.995 }
fn default_epsilon_min() -> f32 { 0.05 }
...
impl RLConfig {
    ...
    pub fn get_replay_capacity(&self, memory_tier: MemoryTier) -> usize {
        self.replay_capacity.unwrap_or_else(|| memory_tier.replay_capacity())
    }
